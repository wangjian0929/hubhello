...
public class MonthPager {
    ...
    public MonthPager(int firstDayOfWeek,Calendar monthCalendar) {
        mFirstDayOfWeek = firstDayOfWeek;

        if(monthCalendar==null)
            monthCalendar = CalendarUtils.getTodayCalendar();

        mCurrentMonthCalendar = monthCalendar;
     ...
     */
    public void setCalendarMonths(Calendar focusedMonthCalendar) {
    ...
    private void loadEventsForMonth(CalendarMonth calendarMonth) {
        if (mOnLoadEventsListener == null) {
            Log.d("hjkgjkhjk", "loadEventsForMonth: "+"mOnLoadEventsListener null");
            return;
        }
        else
        {
            Log.d("hjkgjkhjk", "loadEventsForMonth: "+"mOnLoadEventsListener not null");
        }
    ...
    public CalendarMonth getCalendarMonth(@MonthIndex int monthIndex) {
        switch (monthIndex) {
            case PREVIOUS_MONTH:
