...
public class MealsDataList {
    ...
    @Expose
    private List<com.feedAustralia.android.pojo.Menu.Group__> groups = null;
    ...
    public List<com.feedAustralia.android.pojo.Menu.Group__> getGroups() {
        return groups;
    }
    ...
    public List<Object> getChildrenWithAllergies() {
        return childrenWithAllergies;
    }

    public void setChildrenWithAllergies(List<Object> childrenWithAllergies) {
        this.childrenWithAllergies = childrenWithAllergies;
    }
