...
public class Nutrition_  implements Serializable {
    ...
    @SerializedName("count_meals")
    @Expose
    private Integer countMeals;
    @SerializedName("total")
    @Expose
    private Double total;
    @SerializedName("energy_100g_percentage")
    @Expose
    private Double energy100gPercentage;
    @SerializedName("protein_100g_percentage")
    @Expose
    private Double protein100gPercentage;
    @SerializedName("fat_total_100g_percentage")
    @Expose
    private Double fatTotal100gPercentage;
    @SerializedName("fat_saturated_100g_percentage")
    @Expose
    private Double fatSaturated100gPercentage;
    @SerializedName("available_carbohydrate_100g_percentage")
    @Expose
    private Double availableCarbohydrate100gPercentage;
    @SerializedName("total_sugars_100g_percentage")
    @Expose
    private Double totalSugars100gPercentage;
    @SerializedName("sodium_100g_percentage")
    @Expose
    private Double sodium100gPercentage;
    ...
    public Double getEnergy100gPercentage() {
        return energy100gPercentage;
    }

    public void setEnergy100gPercentage(Double energy100gPercentage) {
        this.energy100gPercentage = energy100gPercentage;
    }

    public Double getProtein100gPercentage() {
        return protein100gPercentage;
    }

    public void setProtein100gPercentage(Double protein100gPercentage) {
        this.protein100gPercentage = protein100gPercentage;
    }

    public Double getFatTotal100gPercentage() {
        return fatTotal100gPercentage;
    }

    public void setFatTotal100gPercentage(Double fatTotal100gPercentage) {
        this.fatTotal100gPercentage = fatTotal100gPercentage;
    }

    public Double getFatSaturated100gPercentage() {
        return fatSaturated100gPercentage;
    }

    public void setFatSaturated100gPercentage(Double fatSaturated100gPercentage) {
        this.fatSaturated100gPercentage = fatSaturated100gPercentage;
    }

    public Double getAvailableCarbohydrate100gPercentage() {
        return availableCarbohydrate100gPercentage;
    }

    public void setAvailableCarbohydrate100gPercentage(Double availableCarbohydrate100gPercentage) {
        this.availableCarbohydrate100gPercentage = availableCarbohydrate100gPercentage;
    }

    public Double getTotalSugars100gPercentage() {
        return totalSugars100gPercentage;
    }

    public void setTotalSugars100gPercentage(Double totalSugars100gPercentage) {
        this.totalSugars100gPercentage = totalSugars100gPercentage;
    }

    public Double getSodium100gPercentage() {
        return sodium100gPercentage;
    }

    public void setSodium100gPercentage(Double sodium100gPercentage) {
        this.sodium100gPercentage = sodium100gPercentage;
    }
